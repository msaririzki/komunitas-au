...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-neon-purple text-sm font-bold leading-5 text-white focus:outline-none transition duration-150 ease-in-out'
